...
set binary="C:\x264-x64-2901-aMod-avx2.exe"
set as="C:\avs2pipemod64.exe"
set merge="C:\mkvmerge.exe"
...
%vs% "%~nf1" --y4m - | %binary% --demuxer y4m -o "%~n1.h264" - --input-depth 10 --output-depth 10 --colormatrix bt709 --ref 13 --deblock -1:-1 --me umh --subme 10 --fade-compensate 0.00 --psy-rd 0.85:0.00 --merange 24 --trellis 2 --no-dct-decimate --bframes 8 --b-adapt 2 --direct auto --keyint 240 --min-keyint 23 --rc-lookahead 72 --crf 16 --qcomp 0.7 --aq-mode 3 --aq-strength 1.0
