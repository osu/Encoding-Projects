...
%vs% "%~nf1" --y4m - | %binary% --demuxer y4m -o "%~n1.h264" - --input-depth 10 --output-depth 10 --colormatrix bt709 --ref 13 --deblock -1:-1 --me umh --subme 9 --fade-compensate 0.00 --psy-rd 0.8:0.00 --merange 24 --trellis 2 --no-dct-decimate --bframes 8 --b-adapt 2 --direct auto --keyint 480 --min-keyint 1 --rc-lookahead 72 --crf 16 --qcomp 0.7 --aq-mode 3 --aq-strength 1.0
